...
class ComputeMetricsMultiChannel(NewThreadMultipleExpBaseUtil):
    ...
    def showHowCombineMetrics(
        ...
        self.combineWindow.setLogger(self.logger, self.logs_path, self.log_path)
        self.combineWindow.sigLoadAdditionalAcdcDf.connect(self.loadAdditionalAcdcDf)
    ...
    def criticalNotEnoughSegmFiles(self, exp_path):
        ...
        msg.critical(self, "Not enough segmentation files!", text)
        self.worker.abort = True
        self.worker.waitCond.wakeAll()
