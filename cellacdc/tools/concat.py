...
class ConcatWin(NewThreadMultipleExpBaseUtil):
    ...
    def askSetMeasurements(self, kwargs):
        ...
        self.setMeasurementsWin.addNonMeasurementColumns(existing_colnames)
        self.setMeasurementsWin.setDisabledNotExistingMeasurements(existing_colnames)
    ...
    def showEvent(self, event):
        formats = ("CSV (Comma Separated Values)", "XLS (Excel)")
