...
class ToolActivationView:
    ...
    LEGACY_METHODS = (
        'uncheckQButton',
        'setUncheckedPointsLayers',
        'setUncheckedAllButtons',
        'setUncheckedAllCustomAnnotButtons',
        'onEscape',
        'clearTempBrushImage',
        'disconnectLeftClickButtons',
        'uncheckLeftClickButtons',
        'connectLeftClickButtonsPointsLayersToolbar',
        'connectLeftClickButtons',
        'wand_cb',
        'magicPrompts_cb',
        'copyLostObjContour_cb',
        'manualAnnotPast_cb',
        'copyLostObjectMask',
        'highlightManualAnnotMode',
        'updateHighlightedAxis',
        'updateLostNewCurrentIDs',
        'highlightLostNew',
        'addLostObjsToLostObjImage',
        'highlightHoverLostObj',
        'annotLostObjsToggled',
        'getPrevFrameIDs',
        'setLostNewOldPrevIDs',
        'setTitleFormatter',
        'setTitleText',
        '_copyAllLostObjects_navigateToFrame',
        '_copyAllLostObjects_returnToFrame',
        '_copyAllLostObjects_refreshRp',
        'copyAllLostObjects',
        'copyAllLostObjectsWorkerCritical',
        'copyAllLostObjectsWorkerFinished',
        'restoreHoverObjBrush',
        'hideItemsHoverBrush',
        'updateBrushCursor',
        'setManualAnnotModeEnabledTools',
    ...
    def setUncheckedAllButtons(self, buttonsToNotUncheck=None):
        ...
        self.curvature_tools_view.clearCurvItems(removeItems=False)
    ...
    def uncheckLeftClickButtons(self, sender):
        ...
        self.mode_controls_view.enableSizeSpinbox(False)
    ...
    def updateLostNewCurrentIDs(self):
        ...
        result = self.view_model.tracking.compute_lost_new_ids(
            ...
            previous_deleted_roi_ids=prev_delRoiIDs,
            tracked_lost_ids=tracked_lost_IDs,
        )
        posData.lost_IDs = result.lost_ids
        posData.new_IDs = result.new_ids
        posData.old_IDs = prev_IDs
        posData.IDs = curr_IDs

        out = (
            result.lost_ids, result.new_ids, result.ids_with_holes,
            tracked_lost_IDs, curr_delRoiIDs
        )
        return out
        ...
        if mode != 'Normal division: Lineage tree':
            ...
            if cells_with_parent:
                ...
                for parent, daughters in parent_cell_groups.items():
                    cells_str = ','.join(
                        [str(daughter) for daughter in daughters]
                    )
    ...
    def copyAllLostObjects(self, for_future_frame_n, max_overlap_perc):
        ...
        self.copyAllLostObjectsWorker = workers.CopyAllLostObjectsWorker(
            self.host, posData, for_future_frame_n, max_overlap_perc
        )
