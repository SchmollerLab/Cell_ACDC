...
class LabelEditingView:
    ...
    def assignNewIDfromClickedID(self, clickedID: int, event):
    ...
    def delNewObj(self, checked):
        ...
        new_IDs = removal_result.removed_ids
        posData.lab = removal_result.labels
    ...
    def getClickedID(self, xdata, ydata, text=''):
        ...
        if self.should_prompt_for_background_id(ID):
            ...
            clickedBkgrID = apps.QLineEditDialog(
                ...
                msg=msg, parent=self.host, allowedValues=posData.IDs,
    ...
    def applyEditID(
        ...
        for old_ID, new_ID in oldIDnewIDMapper:
            result = self.label_edits.apply_id_mapping(
                ...
                merge_existing=self.editIDmergeIDs,
                start_max_id=maxID,
            )
            maxID = result.max_id
