...
try:
    ...
    ap.add_argument(
        ...
        "--version",
        action="store_true",
        help=("Get information about Cell-ACDC version and environment"),
    )

    ap.add_argument("--reset", action="store_true", help=("Reset Cell-ACDC settings"))
                ...
                for pathlike in [
                    ...
                    if pathlike in install_details:
                        install_details[pathlike] = (
                            f'"{os.path.abspath(install_details[pathlike])}"'
                        )
