...
class PointsLayersView:
    ...
    LEGACY_METHODS = (
        'checkAskSavePointsLayers',
        'askSavePointsLayer',
        'reinitPointsLayers',
        'clearPointsLayers',
        'askSaveAddedPoints',
        'pointsLayerToggled',
        'addPointsLayerTriggered',
        'logLoadedTablePointsLayer',
        'buttonAddPointsByClickingActive',
        'setupAddPointsByClicking',
        'storeUndoAddPoint',
        'undoAddPoint',
        'getAddedPointId',
        'addPointsByClickingScatterItemHoverEntered',
        'autoPilotZoomToObjToggled',
        'savePointsAddedByClickingFromEndname',
        'markPointsLayerDirty',
        'flushDirtyPointsLayersAutosave',
        'savePointsAddedByClicking',
        'updatePointsLayerClickEntryTableEndname',
        'pointsLayerDfsToData',
        'pointsLayerLoadedDfsToData',
        'setPointsLayerLoadedDfEndanme',
        'pointsLayerClicksDfsToData',
        'pointsLayerDataToDf',
        'restartZoomAutoPilot',
        'resizeRangeWelcomeText',
        'zoomToObj',
        'addPointsByClickingButtonToggled',
        'autoZoomNextObj',
        'autoZoomPrevObj',
        'pointsLayerAutoPilot',
        'getClickEntryTableFilepaths',
        'getClickEntryNewerRecoveryFilepaths',
        'askLoadNewerRecoveryClickEntryDfs',
        'checkClickEntryTableEndnameExists',
        'checkLoadedTableIds',
        'addPointsLayer',
        'loadClickEntryDfs',
        'removeClickedPoints',
        'restorePrevPointIdRightClick',
        'getClickedPointNewId',
        'setHoverCircleAddPoint',
        'isPointIdAlreadyNew',
        'addClickedPoint',
        'showPointsLayerIdsToggled',
        'removePointsLayer',
        'editPointsLayerAppearance',
        'loadPointsLayerWeighingData',
        'pointLayerToolbuttonToggled',
        'getCentroidsPointsData',
        'drawPointsLayers',
    )
    ...
    def should_use_z_slice(
        ...
        *,
        ...
        _, _, saveButton = msg.question(
            self.host, 'Save points layer?', txt,
    ...
    def getClickEntryNewerRecoveryFilepaths(self, tableEndName):
        ...
        for posData in self.data:
            ...
            if not self.should_load_recovery_table(
                ...
                main_mtime=os.path.getmtime(filepath),
            ):
                continue
            ...
            if loadRecoveryIfNewer:
                ...
                if (
                    self.should_load_recovery_table(
                        ...
                        recovery_mtime=(
                            os.path.getmtime(recovery_filepath)
                            if recovery_exists else None
                        ),
                        main_mtime=(
                            os.path.getmtime(filepath)
                            if main_exists else None
                        ),
                    )
                ):
    ...
    def addClickedPoint(self, action, x, y, id):
        ...
        pointsDataPos = action.pointsData.setdefault(self.pos_i, {})
        zSlice = None
        if posData.SizeZ > 1:
            zSlice = self.zSliceScrollBar.sliderPosition()
    ...
    def editPointsLayerAppearance(self, button):
        win = apps.EditPointsLayerAppearanceDialog(parent=self.host)
