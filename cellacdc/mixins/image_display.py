...
class ImageDisplayView:
    ...
    def showNextFrameImageItem(self, checked):
        ...
        for setting, value in plan.settings_updates.items():
    ...
    def updateLabelsAlpha(self, value):
        ...
        self.df_settings.at['overlaySegmMasksAlpha', 'value'] = (
            plan.setting_value
        )
        self.df_settings.to_csv(self.settings_csv_path)
        self.labelsLayerImg1.setOpacity(plan.opacity)
        self.labelsLayerRightImg.setOpacity(plan.opacity)
    ...
    def addFontSizeActions(self, menu, slot):
        fontActionGroup = QActionGroup(self.host)
