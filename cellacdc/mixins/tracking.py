...
class TrackingView:
    """Qt-facing adapter for tracking and manual tracking workflows."""

    LEGACY_METHODS = (
        'getLastTrackedFrame',
        'get_last_tracked_i',
        'initSegmTrackMode',
        'updateLastCheckedFrameWidgets',
        'resetManualBackgroundItems',
        'enableSmartTrack',
        'trackNewIDtoNewIDsFutureFrame',
        'initRealTimeTracker',
        'realTimeTrackingClicked',
        'repeatTrackingVideo',
        'warnRepeatTrackingVideoOnVisitedFrames',
        'warnRepeatTrackingVideoWithAnnotations',
        'warnTrackerInputNotValid',
        'repeatTracking',
        'separateByLabelling',
        'isFirstTimeOnNextFrame',
        'trackManuallyAddedObject',
        'trackFrameCustomTracker',
        'trackFrame',
        'clearAssignedObjsSecondStep',
        'trackSubsetIDs',
        'doSkipTracking',
        'tracking',
        'handleAdditionalInfoRealTimeTracker',
        'keepOnlyNewIDAssignedObjsSecondStep',
        'updateAssignedObjsAcdcTrackerSecondStep',
        'annotateAssignedObjsAcdcTrackerSecondStep',
        'setTrackedLostCentroids',
        'getTrackedLostIDs',
        'manuallyEditTracking',
        'updateGhostMaskOpacity',
        'addManualTrackingItems',
        'removeManualTrackingItems',
        'addManualBackgroundItems',
        'removeManualBackgroundItems',
        'resetManualBackgroundSpinboxID',
        'initManualBackgroundObject',
        'initGhostObject',
        'clearGhost',
        'clearManualBackgroundAnnotations',
        'clearGhostContour',
        'clearGhostMask',
        '_drawGhostContour',
        '_drawManualBackgroundObjContour',
        '_drawGhostMask',
        'drawManualBackgroundObj',
        'drawManualTrackingGhost',
        'setManualBackgroundImage',
        'setManualBackgrounNextID',
        'clearManualBackgroundObject',
        'addManualBackgroundObject',
        'setManualBackgroundLab',
        'manualTracking_cb',
        'manualBackground_cb',
    )
    ...
    def initSegmTrackMode(self):
        ...
        if posData.frame_i > last_tracked_i:
            ...
            goToButton, stayButton = msg.warning(
                self.host, 'Go to last visited frame?', txt,
                buttonsTexts=(
        ...
        *,
        ...
        return scan_future_id_propagation(
            ...
            yesButton, noButton = msg.question(
                self.host, 'Keep tracking always active?', txt,
                buttonsTexts=('Yes', 'No')
            )
    ...
    def repeatTrackingVideo(self, checked=False):
        ...
        self.progressWin = apps.QDialogWorkerProgress(
            title='Tracking', parent=self.host, pbarDesc=info_txt
        )
    ...
    def warnRepeatTrackingVideoOnVisitedFrames(self, last_tracked_i, start_n):
        ...
        noButton, yesButton = msg.warning(
            self.host, 'Repating tracking with annotations!', txt,
            buttonsTexts=(
    ...
    def warnTrackerInputNotValid(self, trackerName, warningText):
        ...
        msg.warning(self.host, 'Invalid input for tracker', txt)
    ...
    def repeatTracking(self):
        ...
        if posData.editID_info:
            ...
            msg.question(
                self.host, 'Repeat tracking mode', txt,
    ...
    def setTrackedLostCentroids(self, prev_rp, tracked_lost_IDs):
        ...
        try:
            posData.tracked_lost_centroids[frame_i].update(centroids)
        except KeyError:
            posData.tracked_lost_centroids[frame_i] = centroids
    ...
    def getTrackedLostIDs(self, prev_lab=None, IDs_in_frames=None, frame_i=None):
        ...
        posData.tracked_lost_centroids[frame_i] = result.remaining_centroids
        posData.trackedLostIDs = result.lost_ids

        return result.lost_ids
    ...
    def manuallyEditTracking(self, tracked_lab, allIDs):
        ...
        posData.editID_info = result.remaining_edit_info
