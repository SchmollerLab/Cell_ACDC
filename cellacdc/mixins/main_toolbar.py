...
class MainToolbarMixin:
    ...
    def gui_createToolBars(self):
        ...
        self.segmNdimIndicatorAction = fileToolBar.addWidget(self.segmNdimIndicator)
        ...
        self.countObjsButtonAction = navigateToolBar.addWidget(self.countObjsButton)
        ...
        self.copyLostObjButton.action = editToolBar.addWidget(self.copyLostObjButton)
        self.checkableButtons.append(self.copyLostObjButton)
        self.checkableQButtonsGroup.addButton(self.copyLostObjButton)
        self.widgetsWithShortcut["Copy lost object contour"] = self.copyLostObjButton
        ...
        self.manualBackgroundAction = editToolBar.addWidget(self.manualBackgroundButton)
        ...
        self.moveLabelToolButton.action = editToolBar.addWidget(
        ...
        self.expandLabelToolButton.action = editToolBar.addWidget(
            self.expandLabelToolButton
        )
        ...
        self.delNewObjAction.button = editToolBar.widgetForAction(self.delNewObjAction)
        ...
        self.manualTrackingAction = editToolBar.addWidget(self.manualTrackingButton)
        ...
        self.widgetsWithShortcut["Find next potential mother (lineage tree)"] = (
            self.findNextMotherButton
        )
        ...
        self.widgetsWithShortcut["Unknown lineage (lineage tree)"] = (
