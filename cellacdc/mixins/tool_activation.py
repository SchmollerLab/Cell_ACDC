...
class ToolActivationMixin:
    ...
    def setTitleText(
        ...
        if prev_segmented:
            ...
            htmlTxt = '<font color="white">Never segmented frame. </font>'
            self.titleLabel.setText(htmlTxt)
    ...
    def should_highlight_hover_lost_object(
        ...
        *,
        ...
        return has_no_modifier and copy_lost_object_checked and not is_exit_event
