...
class QuickSettings(Actions):
    ...
    def gui_createQuickSettingsWidgets(self):
        ...
        layout.addRow(
            viewCombineChannelDataToggleLabel, self.viewCombineChannelDataToggle
        )
        ...
        layout.addRow(self.autoSaveIntervalLabel, self.autoSaveIntervalEditButton)
        ...
        annotLostObjsToggleTooltip = "Toggle annotation of lost objects mode ON/OFF"
        ...
        self.showAllContoursToggle.toggled.connect(self.showAllContoursToggled)
