...
class OMEXML(object):
    ...
    See the `OME-XML schema documentation <http://git.openmicroscopy.org/cellacdc/develop/components/specification/Documentation/Generated/OME-2011-06/ome.html>`_.
    ...
    class Objective(object):
        ...
        NominalMagnification = property(
            get_NominalMagnification, set_NominalMagnification
        )
