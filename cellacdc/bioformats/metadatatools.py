...
class MetadataStore(object):
    ...
    setPixelsType = jutil.make_method(
        "setPixelsType",
        "(Lome/xml/model/enums/PixelType;I)V",
    ...
    def setLogicalChannelSamplesPerPixel(
        self, samplesPerPixel, imageIndex, channelIndex
    ):
...
class MetadataRetrieve(object):
    ...
    getChannelID = jutil.make_method(
        "getChannelID",
        "(II)Ljava/lang/String;",
...
def get_metadata_options(level):
    ...
    """
    jlevel = jutil.get_static_field(
        "loci/formats/in/MetadataLevel", level, "Lloci/formats/in/MetadataLevel;"
    )
