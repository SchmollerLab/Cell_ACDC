...
from .core import (UnetModel, assign_device, check_mkl, use_gpu, convert_images,
                  MXNET_ENABLED, parse_model_string)
...
class Cellpose():
    ...
    """
    def __init__(
            self, gpu=False, model_type='cyto',
            net_avg=True, device=None, torch=True,
            model_dir=''):
...
class CellposeModel(UnetModel):
    ...
    def __init__(
            self, gpu=False, pretrained_model=False, torch=True,
