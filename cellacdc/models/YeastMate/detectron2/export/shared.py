...
def to_device(t, device_str):
    ...
    if cellacdc == dst:
        return t
    elif cellacdc.type == "cuda" and dst.type == "cpu":
        return torch.ops._caffe2.CopyGPUToCPU(t)
    elif cellacdc.type == "cpu" and dst.type == "cuda":
        return torch.ops._caffe2.CopyCPUToGPU(t)
    else:
        raise RuntimeError("Can't cast tensor from device {} to device {}".format(cellacdc, dst))
