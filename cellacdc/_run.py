        ...
        while True:
            ...
            if answer.lower() == "y" or not answer:
                ...
                if is_mac_arm64 and is_conda_env():
                    subprocess.check_call([f"{conda_prefix} pyqt"], shell=True)
                else:
...
def _exit_on_setup(caller_name="Cell-ACDC"):
    print("*" * 60)
    note_text = f"[NOTE]: {caller_name} had to install the required libraries. "
    note_text = (
        f"{note_text}Please, re-start the software. Thank you for your patience! "
    )
    ...
    if parser_args["yes"]:
        ...
        note_text = f"{note_text}(Press any key to exit). "
        input(note_text)
...
def download_model_params():
        ...
        try:
            ...
            for model_name in model_names:
                ...
                try:
                    ...
                    print(f"[WARNING]: Failed to download {model_name} model weights. ")
                    print(e)
                    pass
            ...
            print("[WARNING]: Failed to download Cellpose model weights. ")
            print(e)
            pass
    if parser_args["StarDistModelsDownload"] or parser_args["AllModelsDownload"]:
        ...
        try:
            ...
            print("[WARNING]: Failed to download StarDist model weights. ")
            print(e)
            pass
    if parser_args["YeaZModelsDownload"] or parser_args["AllModelsDownload"]:
        ...
        try:
            ...
            print("[WARNING]: Failed to download YeaZ model weights. ")
            print(e)
            pass
    if parser_args["DeepSeaModelsDownload"] or parser_args["AllModelsDownload"]:
        ...
        try:
            ...
            print("[WARNING]: Failed to download DeepSea model weights. ")
            print(e)
            pass
    ...
    if parser_args["TrackastraModelsDownload"] or parser_args["AllModelsDownload"]:
        ...
        try:
            ...
            print("[WARNING]: Failed to download TrackAstra model weights. ")
            print(e)
            pass
...
def _setup_app(splashscreen=False, icon_path=None, logo_path=None, scheme=None):
    ...
    if is_copy_qrc_required:
        ...
        _copy_qrc_resources_file(qrc_resources_scheme_path, qrc_resources_path)
...
def _setup_numpy(caller_name="Cell-ACDC"):
    ...
    try:
        with urllib.request.urlopen(url) as response:
            ...
            numpy_versions = [req for req in requires_dist if "numpy" in req.lower()]
