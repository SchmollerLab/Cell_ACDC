...
class tracker:
    def __init__(self, model_checkpoint_path: os.PathLike = TAPIR_CHECKPOINT_PATH):
    ...
    def track(
        ...
        max_distance=5,
        save_napari_tracks=False,
        use_visibile_information=True,
        export_to=None,
        signals=None,
        ...
        frames_rgb = self._get_frames_to_track(
            reversed_resized_frames, reversed_resized_segm, tracking_input
        )
        query_points, tracks_start_frames = self._initialize_query_points(
            reversed_resized_segm,
            tracking_input,
        ...
        self.reversed_tracks, self.reversed_visibles = inference(
            frames_rgb, query_points, self.model_apply, self.params, self.state
        )
    ...
    def _get_frames_to_track(
        self, reversed_resized_frames, reversed_resized_segm, tracking_input
    ):
