...
class tracker:
    ...
    def track_frame(
        ...
        tracked_rp_1st_step_mapper = {obj.label: obj for obj in tracked_rp_1st_step}
        ...
        new_rp_mapper = {
            obj.label: obj
            for obj in tracked_rp_1st_step
        ...
        if self._annot_obj_2nd_step:
            to_track_tracked_objs_2nd_step = (objs_to_track, tracked_objs_2nd_step)
