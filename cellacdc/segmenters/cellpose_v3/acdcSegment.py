...
from cellacdc.segmenters._cellpose_base.acdcSegment import (BackboneOptions, GPUDirectMLGPUCPU, cpu_gpu_directml_gpu,
...
class Model(CellposeBaseModel):
    ...
    def __init__(
        ...
        directml_gpu, gpu, proceed = check_directml_gpu_gpu(
            'cellpose_v3', directml_gpu=directml_gpu, gpu=gpu,
        )
