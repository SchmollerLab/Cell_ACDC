...
try:
    ...
    if sys.platform.startswith("win"):
        ...
        win.exec_()
        if win.cancel:
            raise ModuleNotFoundError("User cancelled Visual C++ installation")
...
try:
    ...
    cancel = utils._install_package_msg("YeastMate")
    if cancel:
        raise ModuleNotFoundError("User aborted YeastMate installation")
