...
class QDialogAbout(QDialog):
    def __init__(self, parent=None):
        ...
        commandWidget = widgets.CopiableCommandWidget(command=command, font_size="11px")

        if command_github is not None:
            commandLabelGh = QLabel(
                html_utils.paragraph(
        ...
        self.copyCellACDCpathButton.clicked.connect(self.copyCellACDCpath)
        ...
        self.howToInstallDialog.setWindowTitle(f"How to install Cell-ACDC v{version}")
